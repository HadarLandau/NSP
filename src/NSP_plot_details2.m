...
function [] = NSP_plot_details2 (details)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  for k=1:J
    ...
    mean_norms(k)=mean(details_norms{k});
  end
  ...
  for k=1:J
         ...
         ylabel(['$\nu_{', num2str(k), '}=', num2str(mean_norms(k)),'$'],...
                           'interpreter', 'latex',"Rotation",0,'FontSize',8);
